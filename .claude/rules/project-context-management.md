# Plan Structure: Project Context Management Section

When creating implementation plans (`.plan.md` files), include a **"Project Context Management"** section at the end with these steps:

## Required Final Steps in Every Plan
...
### 3. docs/IMPLEMENTATION.md (if applicable)
...
1. **docs/ISSUES.md** - Mark off completed work items
2. **docs/IMPLEMENTATION.md** - [Add notes if architectural work was done or unusual patterns were used]
3. **docs/LATER.md** - Add deferred items:
   - [List specific deferred items here]
```

This ensures plans include the full workflow from implementation through documentation updates.
