...
export default [
  ...
  // covers; per-file entries for mixed dirs that still hold Qwik files.
  {
    files: [
      ...
      'src/components/DataField/TextKvField.tsx',
      'src/components/DataField/NumberKvField.tsx',
      'src/components/DataField/SingleImageField.tsx',
      'src/components/DataField/AssetDocField.tsx',
